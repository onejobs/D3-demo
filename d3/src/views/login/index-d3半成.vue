...
export default {
  ...
  methods: {
    ...
    showChart() {
      ...
      // this.drawChart("divid", options, data);
      // this.drawChart(options, data);
    },
    // 第二步
    drawChart(divid, options, datas, dataFilter) {
      ...
      var svgChart = d3.select("svg"); //选择文档中的svg元素
      ...
      //     links.push(e);
      //     // console.log(links);
      //     // console.log(JSON.stringify(links[6]));
      // }
